...
public class OrderTest {
    ...
    // Метод для закрытия окна cookie
    private void closeCookieConsent() {
        MainPage mainPage = new MainPage(webDriver);
        if (!webDriver.findElements(mainPage.getCookieConsentButton()).isEmpty()) {
            webDriver.findElement(mainPage.getCookieConsentButton()).click();
        }
    }
